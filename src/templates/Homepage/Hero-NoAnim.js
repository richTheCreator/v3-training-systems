  ...
  >
    <Overlay xs>
      <HeroTitle p={[0, 4, 5, 7]} xs={12}>
        ...
        <svg className="outlinedFont" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 20">
      ...
      <LegendWrapper justifyContent={['flex-start', 'center', 'center']}>
        <Legend p={[4, 5, 6]} bg="white" md={10} sm={10} xs={10}>
          ...
          >
            <PreviewCompatibleImage isFixed imageInfo={hero.dots__image} style={dotStyle} />
